...
function MarketStatus() {
  ...
  return (
    <span className="inline-flex items-center gap-2 text-[12px] text-[#8A8A84]">
      ...
      {live ? 'Bitget live' : 'Demo fallback'}
    </span>
  );
}
        ...
        <section className="mx-auto grid min-h-[760px] max-w-[1240px] items-center gap-14 px-5 py-20 md:px-8 lg:grid-cols-[1.08fr_.92fr] lg:py-28">
          ...
          <div className="relative fade-up stagger-2">
            ...
            <div className="relative overflow-hidden rounded-[28px] border border-[#D9D7CF] bg-white p-6 shadow-[0_24px_80px_-48px_rgba(20,20,18,.35)] md:p-8">
              <div className="flex items-center justify-between"><div><MicroLabel>NightWatch live brief</MicroLabel><div className="mt-2 text-[12px] text-[#8A8A84]">{status === 'live' ? 'Live Bitget market data' : 'Preview data while market API connects'}</div></div><MarketStatus /></div>
              ...
              <p className="mt-3 text-[14px] leading-6 text-[#55554F]">Before chasing momentum, compare the live Bitget move with historical behaviour and test how the thesis survives a weaker Nasdaq session.</p>
