    ...
    <div className="fade-up">
      ...
      <div className="mt-8 grid gap-5 lg:grid-cols-[.76fr_1.24fr]">
        <section className="rounded-[26px] border border-[#E7E5DE] bg-white p-5 sm:p-6">
          ...
          <div className="mt-5"><FieldLabel>Scenario intensity · {risk.toFixed(1)}%</FieldLabel><input aria-label="Scenario intensity" type="range" min="0.5" max="10" step="0.5" value={risk} onChange={(event) => setRisk(Number(event.target.value))} className="w-full accent-[#141412]" /><p className="mt-2 text-[12px] leading-5 text-[#8A8A84]">This only changes the stress test. No money is moved.</p></div>
