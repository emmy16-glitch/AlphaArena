...
export function ArenaScreen({ onNav, initialSymbol = 'rNVDA', initialThesis = '', initialAiSide = 'WAIT' }: { onNav: Nav; initialSymbol?: string; initialThesis?: string; initialAiSide?: Direction }) {
  ...
  return <div className="fade-up">
    <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between"><div><MicroLabel>Arena · Virtual capital</MicroLabel><h1 className="mt-3 text-[46px] font-semibold tracking-[-0.055em] md:text-[62px]">You have a thesis. <span className="serif-italic font-normal text-[#55554F]">Prove it.</span></h1><p className="mt-3 max-w-[650px] text-[14px] leading-6 text-[#55554F]">No deposit. No wallet. No real-money execution. Record a paper position at a live Bitget Reality price and let the observed market settle it.</p></div><Swords size={48} strokeWidth={1.2} className="hidden text-[#D9D7CF] md:block" /></div>
